    ...
    <div id='home' className='app__header app__flex'>
      ...
      >
        <div className='app__header-badge'>
          ...
          <p>I am a Computer Science and Physics double major at the University of Maryland, College Park. I develop websites and apps to solve problems with machine learning.</p>
          ...
          <div className='social-cmp app__flex'>
            <a href='https://www.linkedin.com/in/gracelcai/' target="_blank" rel="noopener noreferrer">
               {/* <img src={images.linkedin}/> */}
               LinkedIn
            </a>
            <a href='https://github.com/gracelcai' target="_blank" rel="noopener noreferrer">GitHub</a>
          </div>
